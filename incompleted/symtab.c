...
ConstantValue* makeDoubleConstant(float f) {
  ConstantValue* value = (ConstantValue*) malloc(sizeof(ConstantValue));
...
ConstantValue* duplicateConstantValue(ConstantValue* v) {
  ...
  value->type = v->type;
  switch(v->type){
    case TP_INT: value->intValue = v->intValue; break;
    case TP_DOUBLE: value->fValue = v->fValue; break;
    case TP_CHAR: value->charValue = v->charValue; break;
    case TP_STRING: value->str = v->str; break;
    case TP_ARRAY: break;
  }
  return value;
}
